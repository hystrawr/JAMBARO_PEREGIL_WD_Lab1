GearHub - Gaming Hardware Store

An e-commerce storefront built with React, TypeScript, and Tailwind CSS. 

Features 
-real-time search 
-category filters 
-item preview modals and a dynamic cart drawer with live subtotal and shipping calculations
