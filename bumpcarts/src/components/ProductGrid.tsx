    ...
    <div className="p-6 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredProducts.map((product) => (
          ...
          >
            <div className="bg-white p-2 rounded-lg mb-4 flex justify-center items-center h-48">
              <img
                src={product.image}
                alt={product.name}
      ...
      {selectedProduct && (
        ...
        >
          ...
          >
            ...
            {/* Modal Content */}
            <div className="bg-white p-4 rounded-xl mb-4 flex justify-center items-center h-60">
              <img
