...
export default function Navbar() {
  const { state, dispatch, totalCartCount } = useShop();
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-pink-500 text-white font-semibold text-xs px-4 py-1.5 pr-7 rounded-md cursor-pointer focus:outline-none"
            >
